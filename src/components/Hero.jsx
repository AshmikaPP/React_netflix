...
const Hero=()=>{
    ...
    const  { title,backdrop_path,release_data,overview}=movie;
    ...
    <div className='w-full h-[550px] lg:h-[850px]' >
        <div className='w-full h-full'>
            <div className='absolute w-full h-[550px] lg:h-[850px] bg-gradient-to-r from-black'/>
                ...
                <div className='absolute w-full top-[10%] lg:top-[25%] p4 md:p-8'>
                    ...
                    <p className='text-gray-400 text-sm'>{release_data}</p>
